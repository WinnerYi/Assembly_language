...
extern char team[];
extern char member_1_name[];
extern char member_2_name[];
extern char member_3_name[];
...
int main()
{
	...
	printf( "*****Print All*****\n" );
	printf( "by %s", team);
	printf("%d   %s", member_1, member_1_name);
    printf("%d   %s", member_2, member_2_name);
    printf("%d   %s", member_3, member_3_name);
